<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateWESDetailPage.aspx.cs"
    Inherits="Assignment2.HTML.WESDetailFolder.UpdateWESDetailPage" MasterPageFile="~/Site.master" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <div class="padding">
        ...
        <br />
        <asp:Button ID="btnWESDetail" runat="server" Text="Update WES Detail" OnClick="btnWESDetail_Click" />
    </div>
</asp:Content>
